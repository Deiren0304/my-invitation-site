  ...
  return (
    <>
      {/* NEW: Full-Screen Transition Loader
        Moved OUTSIDE of the conditionals so it successfully overlays 
        BOTH the Info View AND the Gallery View when switching between them!
      */}
      {isTransitioning && (
              ...
              {!showRsvp ? (
                <>
                  ...
                  <section className="w-full flex flex-col items-center">
                    ...
                    {/* View Full Gallery Button using transition handler */}
                    <div className="mt-10 animate-fade-in delay-[1250ms] [animation-fill-mode:forwards] opacity-0">
                      <button 
                        onClick={() => handleToggleGallery(true)}
                        className="inline-flex items-center gap-3 px-8 py-3.5 border-2 border-[#B58382]/50 hover:border-[#844C44] bg-white/40 backdrop-blur-sm hover:bg-[#844C44] text-[#844C44] hover:text-[#F5EBE1] text-[10px] md:text-xs uppercase tracking-[0.25em] font-bold rounded-full transition-all duration-400 ease-out hover:-translate-y-1 shadow-[0_8px_30px_rgb(0,0,0,0.04)] cursor-pointer"
                      >
