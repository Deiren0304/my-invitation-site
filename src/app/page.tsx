...
export default function Home() {
  ...
  // NEW: Audio states and reference
  ...
  const handleOpenInvitation = () => {
    ...
    // NEW: Play music seamlessly when they click the envelope
    if (audioRef.current) {
  ...
  return (
    <>
      {/* NEW: Global Audio Element (Hidden) - Loops continuously */}
      ...
      {/* NEW: Floating Music Control Toggle - Only shows once envelope is opened */}
      {isOpened && (
        <button
          onClick={toggleMusic}
